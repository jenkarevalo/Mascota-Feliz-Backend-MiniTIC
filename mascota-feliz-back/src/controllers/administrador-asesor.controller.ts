...
export class AdministradorAsesorController {
  ...
  async find(
    ...
    return this.administradorRepository.asesores(id).find(filter);
  }
  ...
  async create(
    ...
    return this.administradorRepository.asesores(id).create(asesor);
  }
  ...
  async patch(
    ...
    return this.administradorRepository.asesores(id).patch(asesor, where);
  }
  ...
  async delete(
    ...
    return this.administradorRepository.asesores(id).delete(where);
  }
}
